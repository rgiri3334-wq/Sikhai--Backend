...
async def get_current_user(credentials: HTTPAuthorizationCredentials = Depends(bearer)) -> UserProfile:
...
async def register_user(name: str, email: str, password: str, grade: Optional[str], language: str) -> dict:
    db = get_db()
